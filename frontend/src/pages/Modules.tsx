...
const ALL_MODULES = [
  ...
  { id: 'beneficios',            icon: '🎁', title: 'Benefícios',                  description: 'Benefício transporte mensal — crédito, consumo e saldo por colaborador CLT',       path: '/modulos/beneficios',            color: '#00897b', group: 'folha' },
