...
const ALL_MODULES = [
  ...
  { id: 'freelancer-pagamento',  icon: '🎯', title: 'Pagamento de Freelancers',  description: 'Auditoria e confirmação de pagamentos de freelancers por semana',                  path: '/modulos/freelancer-pagamento',  color: '#388e3c' },
  { id: 'motoboy-auditoria',     icon: '🔍', title: 'Auditoria de Motoboys',     description: 'Visão linha a linha de chegadas, entregas e descontos por semana',                path: '/modulos/motoboy-auditoria',     color: '#1b5e20' },
  ...
  { id: 'adiantamentos-saldos',  icon: '🧾', title: 'Adiantamentos e Saldos',      description: 'Controle adiantamentos especiais, parcelas e saldos em aberto',                  path: '/modulos/adiantamentos-saldos',  color: '#7b1fa2' },
