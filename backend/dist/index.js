...
// Caixa - Abertura
app.post('/api/caixa/abertura', (req, res) => {
...
// Caixa - Recebimento
app.post('/api/caixa/recebimento', (req, res) => {
...
// Caixa - Fechamento
app.post('/api/caixa/fechamento', (req, res) => {
...
app.post('/api/escalas/presenca', (req, res) => {
...
app.post('/api/motoboys/lancamento', (req, res) => {
